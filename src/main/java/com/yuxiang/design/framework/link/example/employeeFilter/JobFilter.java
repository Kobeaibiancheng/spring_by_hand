...
@Slf4j
@Service
public class JobFilter implements ILogicHandler<UserInformationEntity, EmployeeInformationRuleFilterFactory.DynamicContext, UserInformationRuleFilterBackEntity> {
    @Override
